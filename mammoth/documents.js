...
function Run(children, properties) {
  properties = properties || {};
  //console.log(properties.color, "color");
  //console.log(properties.background, "bgcolor");
  return {
    type: types.run,
    children: children,
    styleId: properties.styleId || null,
...
function Image(options) {
  ...
  let _ = options.readImage("base64").then(function (imageBuffer) {
    return "data:" + options.contentType + ";base64," + imageBuffer;
  });
